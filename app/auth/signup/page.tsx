...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4 mt-20 sm:px-6">
            ...
            <form className="space-y-6">
              ...
              <div className="bg-background/50 rounded-2xl px-6 space-y-2">
                <Label htmlFor="phone" className="text-foreground font-medium flex items-center gap-2">
                  <div className="w-8 h-8 rounded-xl bg-linear-to-br from-[#3d7a78] to-[#4d8a88] flex items-center justify-center">
              ...
              <div className="bg-background/50 rounded-2xl px-6 space-y-2">
                <Label htmlFor="due-date" className="text-foreground font-medium flex items-center gap-2">
                  <div className="w-8 h-8 rounded-xl bg-linear-to-br from-[#4d8a88] to-[#5d9a98] flex items-center justify-center">
              ...
              <div className="flex items-start space-x-2">
                ...
                >
                  I agree to the{" "}
                  <Link href="/terms" className="font-medium text-[#1f4b4a] hover:text-[#2d6a68] transition-colors">
                    Terms of Service
                  </Link>
                  {" "}and{" "}
                  <Link href="/privacy" className="font-medium text-[#1f4b4a] hover:text-[#2d6a68] transition-colors">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-secondary/30 text-muted-foreground">Or sign up with</span>
                </div>
              </div>
